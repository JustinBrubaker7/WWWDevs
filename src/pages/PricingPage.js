...
const tiers = [
  {
    ...
    priceMonthly: "1,000",
    description:
      "Template WordPress Website. You will have the freedom to alter content and make some design choices.",
  },
  {
    name: "Pro",
    href: "#",
    priceMonthly: "2,500",
    description:
      "Customized WordPress theme. Your website will feel custom by making design and functionality changes to a current theme.",
  },
  {
    name: "Premium",
    href: "#",
    priceMonthly: "5,000+",
    description:
      "Website built from scratch. We will build an entirely new theme and provide mock ups along with revisions. Nothing is impossible.",
  },
];
const sections = [
  {
          ...
          {tiers.map((tier) => (
            <section key={tier.name}>
              <div className="px-4 mb-8">
                ...
                <a
                  href={tier.href}
                  className="mt-6 block w-full bg-gradient-to-r from-yellow-400 to-gray-500 border border-transparent rounded-md shadow py-2 text-sm font-semibold text-white text-center hover:to-pink-600"
                >
                  Buy {tier.name}
                </a>
              </div>
              ...
              <div className="border-t border-gray-200 px-4 pt-5">
                <a
                  href="#"
                  className="block w-full bg-gradient-to-r from-yellow-400 to-gray-500 border border-transparent rounded-md shadow py-2 text-sm font-semibold text-white text-center hover:to-pink-600"
                >
                  Buy {tier.name}
                </a>
              </div>
                ...
                {tiers.map((tier) => (
                  <td key={tier.name} className="h-full py-8 px-6 align-top">
                    <div className="h-full flex flex-col justify-between">
                      ...
                      <a
                        href={tier.href}
                        className="mt-6 block w-full bg-gradient-to-r from-yellow-400 to-yellow-600 border border-transparent rounded-md shadow py-2 text-sm font-semibold text-white text-center hover:to-pink-600"
                      >
                        Buy {tier.name}
                      </a>
                    </div>
